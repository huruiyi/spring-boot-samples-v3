...
public class UserController {
  ...
  /**
   * 事务测试：创建用户和订单（使用自定义参数） 用于测试多数据源的事务提交与回滚
   * <p>
   * 参数说明： - rollback: true=测试回滚（会抛出异常），false=正常提交 - username: 用户名 - email: 邮箱 - phone: 电话 - orderNo: 订单号 - productName: 产品名称 - quantity: 数量 - totalPrice: 总价格
   */
  ...
  /**
   * 事务测试：创建用户和订单（使用写死的数据） 用于快速测试事务提交与回滚
   * <p>
   * 参数说明： - rollback: true=测试回滚（会抛出异常），false=正常提交
   */
